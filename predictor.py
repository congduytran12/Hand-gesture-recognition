...
def show_statistics(predicted_class, confidence):
    ...
    cv2.putText(text_image,"Predicted Class : " + class_name, (30, 30), 
    cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)

    cv2.putText(text_image,"Confidence : " + str(confidence * 100) + '%', (30, 100), 
    cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
...
# load saved model
model.load("trained_model/gesture_recognition_model.tfl")
